        ...
        if choice=='1':
            ...
            with open('LSB/result/Extract/ssim.txt', 'w') as file:
                ...
                for i in attacks:
                    ...
                    attacked_image_path = os.path.join('LSB/image/Extract', attacked_image_filename)
